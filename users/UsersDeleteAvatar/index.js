...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (userItem.activeAvatarId === avatarId) {
      return { statusCode: 400, headers: corsHeaders, body: JSON.stringify({ error: 'Cannot delete active avatar' }) };
    }
    ...
    return { statusCode: 200, headers: corsHeaders, body: JSON.stringify({ message: 'Avatar deleted', avatarId }) };
  } catch (error) {
